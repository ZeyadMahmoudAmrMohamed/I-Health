...
<link href="<%=request.getContextPath()%>/CSS/index-styles.css" rel="stylesheet" />
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">HealthCare App Doctor Profile Page</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
						...
						class="nav-link py-3 px-0 px-lg-3 rounded"href="<%=request.getContextPath()%>/Doctor/homepage.jsp">Home </a></li>
