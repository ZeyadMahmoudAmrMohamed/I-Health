...
<link href="<%=request.getContextPath()%>/CSS/index-styles.css" rel="stylesheet" />
    ...
    <body>
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" >Remove Pharmacy Item</a>
			<button
             ...
             <style>img {
                              ...
                              blockquote {
                                ...
                                <section class="page-section portfolio" id="portfolio"></section><div>
                                    <form action="<%=request.getContextPath()%>/delPharItemController" method="post">
                                        <table align="center">
                                         ...
                                         <tr>
                                              <td>
                                               ...
                                               <input type="text" name="iname" class="" required/>                                             
                                             </td>
